...
# Import telemetry FIRST — it sets the global tracer/meter providers
# that every other app module (orchestrator, agents, services) reads
# from at import time via app.telemetry.tracer / app.otel_metrics.*.
